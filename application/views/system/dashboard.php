...
<head>
    ...
    <title>Vida Café & Bistro - Admin</title>
    <meta name="viewport"
...
<body>
    <?php if(!empty($modal_view))$this->load->view($modal_view); ?>                    
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a id="mn_home" href="<?=site_url('admin/home')?>">
                                    <i class="metismenu-icon pe-7s-home"></i>
                                    Home
                                </a>
                            </li>
                            <li>
                                <a id="mn_reservation" href="<?=site_url('admin/reservation')?>">
                            ...
                            <li>
                                <a id="mn_menu" href="<?=site_url('admin/menu')?>">
                            ...
                            <li>
                                <a id="mn_user" href="<?=site_url('admin/user')?>">
